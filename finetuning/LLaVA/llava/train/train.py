...
def train(attn_implementation=None):
    ...
    if model_args.vision_tower is not None:
        ...
        # image_weight = torch.load('/home/hanjh/longitudinal_llm/model/llava_epoch_5_based_alignment_nf_cxr.pt')
        image_weight = torch.load('/home/hanjh/longitudinal_llm/model/model_epoch_5_val_loss_0.2764_llava_v2.pth')
        ...
        # for param in vision_tower.vision_tower.vision_model.parameters():
